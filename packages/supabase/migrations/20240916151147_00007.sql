...
CREATE OR REPLACE FUNCTION "public"."get_business"("store_id_input" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_business"("store_id_input" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_stores"("lat" numeric, "lng" numeric, "radius" numeric) RETURNS "uuid"[]
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  store_ids uuid[];
...
ALTER FUNCTION "public"."get_nearby_stores"("lat" numeric, "lng" numeric, "radius" numeric) OWNER TO "postgres";
...
BEGIN
 ...
 SELECT ARRAY(
    SELECT jsonb_array_elements_text(
      COALESCE(raw_app_meta_data->'store_ids', '[]'::jsonb)
    )::UUID
  )
...
ALTER FUNCTION "public"."search_active_listings"("sport" "text", "experience_input" "text", "rent_period_from" timestamp without time zone, "rent_period_to" timestamp without time zone, "latitude_input" numeric, "longitude_input" numeric, "radius" numeric) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_user_confirmation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_user_confirmation"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tbl_bookings" (
    "booking_id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    ...
    CONSTRAINT "check_positive_price" CHECK (("total_price" >= (0)::numeric))
);
...
CREATE TABLE IF NOT EXISTS "public"."tbl_stores" (
    ...
    "store_img" "text" DEFAULT 'concat(''store/'', store_id, ''/store-img-'', store_id);'::"text",
    "business_email" "text",
    "user_id" "uuid" NOT NULL,
    "address_line2" "text",
    "country" "text",
...
ALTER TABLE ONLY "public"."tbl_bookings"
    ADD CONSTRAINT "tbl_bookings_listing_id_fkey" FOREIGN KEY ("listing_id") REFERENCES "public"."tbl_listings"("listing_id");



ALTER TABLE ONLY "public"."tbl_bookings"
    ADD CONSTRAINT "tbl_bookings_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."tbl_stores"("store_id");



ALTER TABLE ONLY "public"."tbl_bookings"
    ADD CONSTRAINT "tbl_bookings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."tbl_users"("user_id");
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."tbl_bookings" TO "authenticated" USING (true);



CREATE POLICY "READ for all" ON "public"."tbl_listings" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."get_business"("store_id_input" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_business"("store_id_input" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_business"("store_id_input" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_nearby_stores"("lat" numeric, "lng" numeric, "radius" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_stores"("lat" numeric, "lng" numeric, "radius" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_stores"("lat" numeric, "lng" numeric, "radius" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_active_listings"("sport" "text", "experience_input" "text", "rent_period_from" timestamp without time zone, "rent_period_to" timestamp without time zone, "latitude_input" numeric, "longitude_input" numeric, "radius" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."search_active_listings"("sport" "text", "experience_input" "text", "rent_period_from" timestamp without time zone, "rent_period_to" timestamp without time zone, "latitude_input" numeric, "longitude_input" numeric, "radius" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_active_listings"("sport" "text", "experience_input" "text", "rent_period_from" timestamp without time zone, "rent_period_to" timestamp without time zone, "latitude_input" numeric, "longitude_input" numeric, "radius" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_user_confirmation"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_confirmation"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_confirmation"() TO "service_role";
...
GRANT ALL ON TABLE "public"."tbl_bookings" TO "anon";
GRANT ALL ON TABLE "public"."tbl_bookings" TO "authenticated";
GRANT ALL ON TABLE "public"."tbl_bookings" TO "service_role";
